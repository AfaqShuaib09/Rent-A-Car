...
public class CarSelectionMenu {
    ...
    BookingDAO bdao;
    JScrollPane sp;
    CarSelectionMenuBtnHandler hnd;
    ...
    public CarSelectionMenu(AdminMenuGUI refg) {
        adminGUI = refg;
        Dao = new CarDAO();
        bdao = new BookingDAO();
        initGUI();
    ...
    public void initGUI() {
        ...
        hnd = new CarSelectionMenuBtnHandler(this, adminGUI);
        ...
        Car[] tempCarArr = Dao.getAvailableCars(adminGUI.sched_sd, adminGUI.sched_ed);

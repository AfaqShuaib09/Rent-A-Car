...
public class CancelBookingGUI {
    ...
    public CancelBookingGUI(UserMenuGUI refg) {
        userGUI = refg;
        Dao = new CarDAO();
        bdao = new BookingDAO();
        initGUI();
    ...
    public void initGUI() {
        ...
        hnd = new CancelBookingBtnHandler(this, userGUI);
...
//jt.setGridColor(Color.GREEN);
        ...
        removeBtn.setText("Cancel Booking");
        removeBtn.setBackground(Color.red);
        removeBtn.setForeground(Color.white);
        removeBtn.setBounds(600, 100, 150, 30);
    ...
    public void generateDeletionDetailGUI(Booking bk)
    {
     ...
     cRemove = new JButton();
     cRemove.setText("Confirm Unbook");

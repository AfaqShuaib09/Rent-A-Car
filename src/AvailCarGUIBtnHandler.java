 ...
 * @author Afaq
 */
public class AvailCarGUIBtnHandler implements ActionListener{

    AvailableCarsGUI refg;
    AvailCarGUIBtnHandler(AvailableCarsGUI aThis) {
       refg = aThis;
    }
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getActionCommand().equals("OK"))
        {
          ...
          if(refg.msg.getText().equals("            Record Added Succesfully "));
          {
           Vector<String> carAttr = new Vector<String>();
           Car tempCar = new Car(refg.vin.getText(),refg.make.getText(), refg.m_year.getText(), refg.model.getText(),
                      refg.eno.getText(), refg.color.getText(), refg.pdrent.getText());
          carAttr.add(tempCar.getCar_Regd_id());
          carAttr.add(tempCar.getMake());
          carAttr.add(tempCar.getMake_year());
          carAttr.add(tempCar.getModel());
          carAttr.add(tempCar.getEngine_No());
          carAttr.add(tempCar.getColor());
          carAttr.add(tempCar.getPer_day_rent());
          refg.JTmodel.addRow(carAttr);
          resetToDefault();
          }
          refg.popupframe.dispose();

//refg.jt.setVisible(false);
          //refg.jt = refg.Dao.DisplayUserData();
          //refg.jt.setVisible(true);
          //refg.frame.dispose();
          //AvailableCarsGUI a=new AvailableCarsGUI();
        }

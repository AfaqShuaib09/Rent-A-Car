...
public class AdminMenuGUI {
    ...
    AdminMenuBtnHandler hnd;
    JButton Signout, enter;
    JTextField end_date,start_date; 
    MenuView menu1;
    User loggedInUser;
    ...
    public AdminMenuGUI(User loginUser){
    ...
    public void initGUI() {
        ...
        hnd = new AdminMenuBtnHandler(this);
        pan = new JPanel();
        pan.setLocation(0,0);
        pan.setSize(254,723);
        ...
        menu [0][0]= "Schedule A Car";
        menu [0][1]= "Add A Car";
        menu [0][2]= "Remove A Car";
        menu [1][0]= "Calculate Revenue";
        menu [1][1]= "Scheduled Cars";
        menu [1][2]= "Available Cars";
